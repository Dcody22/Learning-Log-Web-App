...
def index(request): 
    ...
    return render(request,'MainApp/index.html') #whatever is in this html file will show on the homepage 


#display the views for the app 
@login_required #decorator to make sure the user can only view and edit their own topics
def topics(request):
